...
scaleColl maxDim curr = maxDim' / curr'
  where
    maxDim' = fmap fromIntegral (V2 3000 maxDim)
    ...
    ( PhysicalState
        ...
        ( Scene
            ( [ ( Terrain
                    ...
                    (Object (V2 3000 10000) (V2 5000 5000) 0)
                ),
                -- (Terrain
                ...
                ( Terrain
                    ...
                    (Object (V2 (3000 + 989 + 324) 0) (V2 5000 5000) 0)
                ),
                ( Terrain
                    ( (fmap . fmap)
                    ...
                    (Object (V2 (3000 + 989 + 324 + 2290 + 256) 0) (V2 5000 5000) 0)
                ),
                ( Terrain
                    ( (fmap . fmap)
                    ...
                    (Object (V2 (3000 + 989 + 324 + 2290 + 256 + 3373 + 157) 0) (V2 5000 5000) 0)
                ),
                ( Terrain
                    ( (fmap . fmap)
                    ...
                    (Object (V2 (3000 + 989 + 324 + 2290 + 256 + 3373 + 157 + 1023 + 1613) 0) (V2 5000 5000) 0)
                )
            ...
            ( [ ( LandingSpot
                    ...
                    ( Terrain
                        ...
                        (Object (V2 (-2000) 10000) (V2 5000 5000) 0)
                    )
                ),
                -- NEW LANDING!!!
                ...
                ( LandingSpot
                    ...
                    ( Terrain
                        ...
                        (Object (V2 (3000 + 989) 0) (V2 5000 5000) 0)
                    )
                ),
                ( LandingSpot
                    3
                    ( Terrain
                        ...
                        (Object (V2 (3000 + 989 + 324 + 2290) 0) (V2 5000 5000) 0)
                    )
                ),
                ( LandingSpot
                    3
                    ( Terrain
                        ...
                        (Object (V2 (3000 + 989 + 324 + 2290 + 256 + 3373) 0) (V2 5000 5000) 0)
                    )
                ),
                ( LandingSpot
                    3
                    ( Terrain
                        ...
                        (Object (V2 (3000 + 989 + 324 + 2290 + 256 + 3373 + 157 + 1023) 0) (V2 5000 5000) 0)
                    )
                )
              ]
            )
